...
function CompanyInfo() {
  return (
    <section className="w-[calc(100vw-2rem)] lg:w-[calc(100vw-8rem)] mt-16 bg-gray-200 rounded-lg p-6 md:p-8 shadow-md text-left">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <motion.div 
            ...
            className="md:w-2/5 aspect-square"
          >
          ...
          >
            ...
            <Link 
              href="/about" 
              className="inline-flex items-center gap-2 bg-black hover:bg-primary/20 text-primary-foreground px-4 py-2 rounded-md transition-colors"
            >
              Learn more about us
              <ArrowRight size={16} />
            </Link>
