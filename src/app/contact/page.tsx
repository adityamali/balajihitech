...
function page() {
  return (
    <div className="flex flex-col items-center justify-center mt-24 pt-8 pb-16">
      ...
      {/* Contact Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-[calc(100vw-8rem)] mb-12">
        <Link href="tel:+918805240301">
          <div className="flex flex-col items-center p-6 border rounded-lg">
            <Phone className="w-10 h-10 text-primary mb-4" />
            <h3 className="font-semibold mb-2">Phone</h3>
            <p className="text-muted-foreground text-center">+91 88052 40301</p>
          </div>
        </Link>
